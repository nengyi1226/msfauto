...
ACLOCAL = ${SHELL} /opt/shc/config/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /opt/shc/config/missing autoconf
AUTOHEADER = ${SHELL} /opt/shc/config/missing autoheader
AUTOMAKE = ${SHELL} /opt/shc/config/missing automake-1.16
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /opt/shc/config/missing makeinfo
...
STRIP = 
VERSION = 4.0.3
abs_builddir = /opt/shc
abs_srcdir = /opt/shc
abs_top_builddir = /opt/shc
abs_top_srcdir = /opt/shc
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /opt/shc/config/install-sh
